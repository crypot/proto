...
public class DefaultKryoContext implements KryoContext {
    ...
    public static KryoContext newKryoContextFactory(KryoClassRegister registrator) {
        return new DefaultKryoContext(registrator);
    }

    private DefaultKryoContext(KryoClassRegister registrator) {
    ...
    private static class KryoFactoryImpl implements KryoFactory {
        private KryoClassRegister registrator;

        public KryoFactoryImpl(KryoClassRegister registrator) {
    ...
    public byte[] ser(Object obj) {
        return ser(obj, DEFAULT_BUFFER);
    }

    @Override
    public byte[] ser(Object obj, int bufferSize) {
        Output output =
    ...
    @Override
    public Object des(Class clazz, byte[] serialized) {
        Object obj;
